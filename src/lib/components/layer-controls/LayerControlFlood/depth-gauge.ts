...
export class DepthGauge {
	...
	private previousAnimateState: boolean = false;
	...
	public activate(): void {
		...
		this.previousAnimateState = get(this.map.options.animate);
	...
	public deactivate() {
		...
		this.measurementId = 0;
		this.removeMovingPoint();
		this.map.options.animate.set(this.previousAnimateState);
