<script lang="ts">
    ...
    import { InlineNotification, Button, TooltipIcon, FileUploaderItem } from "carbon-components-svelte";
    import { TrashCan, AreaCustom, Checkmark, Information } from "carbon-icons-svelte";
