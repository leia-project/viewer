...
<div class="toolbar-button-container" bind:this={ref} on:mouseenter={() => open = hasTooltip} on:mouseleave={() => open = false} style={`--button-size: ${size};`}>
	<div class="toolbar-button" on:click={click} class:active>
		{#if icon}
